  ...
  return (
    <div className='Container' style={{ marginTop: '5rem' }}>
      ...
      <div className="BigCard" style={{ padding: '0 10px 10px 10px' }}>
        ...
        <div style={{ display: "flex", marginTop: '15px', marginLeft: '40px', alignitems: "center" }}>
          <img alt=" " src={"https://www.spacescan.io/images/spacescan-logo-192.png"} style={{ width: "50px", Height: "50px" }} />
          <a style={{ marginTop: '15px', marginLeft: '15px', fontSize: '24px', fontWeight: 'bold' }} href={"https://www.spacescan.io/"} >SPACESCAN</a>
        </div>
        <div style={{ display: "flex", alignitems: "center" }}>
          <p style={{ marginTop: '15px', marginLeft: '40px', fontSize: '16px', fontWeight: 'bold' }}> Fullstack developer</p> &nbsp;
          <p style={{ marginTop: '15px', fontSize: '16px', fontWeight: '' }}> July 2023 - Present </p>
        </div>
        <p style={{ marginLeft: '40px', marginTop: '15px', fontSize: '16px' }}>
